        ...
        protected function singleParamEditForm( $param, $param_value ) {
            ...
            // Textfield - input
                ...
                $param_line .= '<input name="'.$param['param_name'].'" class="wpb_vc_param_value wpb-textinput '.$param['param_name'].' '.$param['type'].'" type="text" value="'.$value.'"/>';
                    ...
                    $param_line .= '<input class="mk-upload-url wpb_vc_param_value '.$param['param_name'].' '.$param['type'].'" type="text" id="' . $param['param_name']. '" name="' . $param['param_name'] . '" size="50"  value="'.$value.'" /><a class="option-upload-button button thickbox" id="' . $param['param_name'] . '_button" href="#">'.__( 'Upload', 'mk_framework' ).'</a>';
            ...
            // Color - input
                    ...
                    $value = __( $param_value, "mk_framework" );
                    $value = $param_value;
                    $param_line .= '<input name="'.$param['param_name'].'" class="color-picker wpb_vc_param_value '.$param['param_name'].' '.$param['type'].'" value="'.$value.'"/>';
            ...
            ** Safe Fonts List
            ...
            // Dropdown - select
                    ...
                    $param_line .= '<select name="'.$param['param_name'].'" class="wpb_vc_param_value wpb-input mk-select wpb-select '.$param['param_name'].' '.$param['type'].'">';
