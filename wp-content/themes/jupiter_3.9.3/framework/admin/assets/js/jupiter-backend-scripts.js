...
jQuery(".mk-chosen-no-search").chosen({disable_search: true});
...
jQuery('#_slideshow_source').change(function() {
	...
	if(this_val == 'flexslider') {
		...
		jQuery('#_edge_section_wrapper').slideDown();
	}
...
post_choices = jQuery('#_mp3_file_wrapper, #_classic_orientation_wrapper, #_audio_iframe_wrapper, #_ogg_file_wrapper, #_single_video_site_wrapper, #_single_video_id_wrapper, #_disable_video_lightbox_wrapper, #_single_audio_author_wrapper');
post_choices.hide();
