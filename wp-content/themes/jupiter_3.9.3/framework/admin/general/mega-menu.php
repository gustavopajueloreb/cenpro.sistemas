...
function mk_menus_hook() {
	...
	wp_enqueue_style( 'mk-font-icomoon', THEME_STYLES . '/icomoon-fonts.css' );
	wp_enqueue_style( 'mk-font-awesome', THEME_STYLES . '/font-awesome.css' );
...
function mk_add_icons_html() {
    ...
    <div id="mk-icon-holder-container">
     ...
     foreach ( $mk_icons_list as $key => $option ) {
		if ( $key ) {
			echo '<a href="#" title="Class Name : mk-'.$key.'" rel="mk-'.$key.'"><span>'.$key.'</span><i class="mk-'.$key.'"></i></a>';
		} else {
