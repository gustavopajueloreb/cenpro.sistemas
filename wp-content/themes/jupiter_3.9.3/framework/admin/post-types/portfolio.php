...
function register_portfolio_post_type(){
	...
	$icon = version_compare(get_bloginfo('version'), '3.8', '>=') ? 'dashicons-portfolio' : false;
	...
	register_post_type('portfolio', array(
		...
		'menu_position' => 90,
		'hierarchical' => false,
		'rewrite' => array('slug' =>$mk_options['portfolio_slug'] ),
		'query_var' => false,
		'show_in_nav_menus' => true,
		'supports' => array('title', 'editor', 'author', 'excerpt', 'thumbnail', 'comments', 'page-attributes'),
	));
