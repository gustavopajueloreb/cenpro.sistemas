...
function blog_modern_style($atts, $current)
{
    ...
    $output .= '<article id="' . get_the_ID() . '" class="mk-blog-modern-item mk-isotop-item ' . $post_type . '-post-type">' . "\n";
    ...
    if ($post_type == 'image' || $post_type == 'portfolio' || $post_type == '') {
        ...
        if (has_post_thumbnail()) {
            ...
            if (($show_lightbox == 'true' || $show_lightbox == '') && $disable_lightbox == 'true') {
                $lightbox_code = ' class="mk-lightbox blog-modern-lightbox" href="' . $image_src_array[0] . '"';
            } else {
