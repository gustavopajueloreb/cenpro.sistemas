...
*************************************************************/
?>
<?php if($mk_options['portfolio_next_prev'] == 'true') : ?>
...
<div id="theme-page">
	...
	if ( $post_type == 'image' ) { ?>
			<div class="single-featured-image">
				<a class="mk-lightbox" data-title="<?php the_title(); ?>" href="<?php echo $image_src_array[0]; ?>"><img alt="<?php the_title(); ?>" title="<?php the_title(); ?>" src="<?php echo $image_src; ?>" height="<?php echo $image_height; ?>" width="<?php echo $image_width; ?>" itemprop="image" /></a>
			</div>
