...
if ($r->have_posts()):
    ...
    if ($post_type == 'post') {
        ...
        if ($blog_post_type != 'audio') {
            ...
            $output .= '<a class="post-type-badge mk-lightbox" href="' . $image_src_array[0] . '"><i class="mk-jupiter-icon-' . $blog_post_type . '"></i></a>';
            $output .= '</div>';
