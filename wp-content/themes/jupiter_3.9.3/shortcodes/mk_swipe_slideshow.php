...
if($direction_nav == 'true') {
	$output .= '<a class="mk-swiper-prev swiper-arrows"><i class="mk-icon-chevron-left"></i></a>';
	$output .= '<a class="mk-swiper-next swiper-arrows"><i class="mk-icon-chevron-right"></i></a>';
}
