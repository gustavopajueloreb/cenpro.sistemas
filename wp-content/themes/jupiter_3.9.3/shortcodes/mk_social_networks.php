...
$output .= !empty( $instagram )  ? '<li><a style="margin: '.$margin.'px;" target="_blank" class="instagram-hover" href="'.$instagram.'"><i style="color:'.$icon_color.'" class="'.$icon_style.'instagram"></i></a></li>' : '';
$output .= !empty( $soundcloud )  ? '<li><a style="margin: '.$margin.'px;" target="_blank" class="soundcloud-hover" href="'.$soundcloud.'"><i style="color:'.$icon_color.'" class="'.$icon_style.'soundcloud"></i></a></li>' : '';
