...
$output .= '<'.$tag_name.' style="font-size: '.$size.'px;text-align:'.$align.';color: '.$color.';font-weight:'.$font_weight.';margin-top:'.$margin_top.'px;margin-bottom:'.$margin_bottom.'px; '.$divider_css.$txt_transform.$letter_spacing.'" id="fancy-title-'.$id.'" class="mk-shortcode mk-fancy-title '.$animation_css.$style.'-style '.$el_class.'"><span style="'.$span_padding.'">';
$output .= $echo_output;
