...
if ( $style == "simple_minimal" ) {
    if ( $circled == 'true' ) {
        ...
        $output .= !empty( $read_more_url ) ? '<a href="'.$read_more_url.'"><i class="mk-'.$icon.$animation_css.' circled-icon mk-main-ico" style="'.$border_css.'color:'.$icon_color.';background-color:'.$icon_circle_color.'"></i></a>' : '<i class="mk-'.$icon.$animation_css.' circled-icon mk-main-ico" style="'.$border_css.'color:'.$icon_color.';background-color:'.$icon_circle_color.'"></i>';
    ...
    if ( $read_more_txt ) {
        ...
        if ( !empty( $icon ) ) {
            $output .= !empty( $read_more_url ) ? '<a href="'.$read_more_url.'"><i style="color:'.$icon_color.';'.$border_color.'" class="mk-'.$icon.$animation_css.' '.$icon_size.' mk-main-ico"></i></a>' : '<i style="color:'.$icon_color.';'.$border_color.'" class="mk-'.$icon.$animation_css.' '.$icon_size.' mk-main-ico"></i>';
        }
